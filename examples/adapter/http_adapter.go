...
func (entity *HttpAdapter) PreUse(args ...interface{}) {
    entity.Flow.PreUse(args...)
}

func (entity *HttpAdapter) MakeRequest(method, url string, data io.Reader, headers map[string]string, cookies map[string]string, bodyType string) (*http.Request, error) {
...
func (entity *HttpAdapter) beforeHttpStat(req *http.Request) *timeTrace {
...
func (entity *HttpAdapter) afterHttpStat(scheme string, t *timeTrace) {
    if entity.ApiConf.HttpStat == false {
        return
    }
...
func (entity *HttpAdapter) httpDo(apiReq *ApiRequest) (httpCode int, response []byte, field []zap.Field, err error) {
    start := time.Now()
    fields := []zap.Field{
...
func (entity *HttpAdapter) Request(method string, uri string, reqBody []byte, header map[string]string, cookies map[string]string, contentType string) (data []byte, err error) {
